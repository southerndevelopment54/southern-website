...
import com.securityco.config.JwtConfig;
...
public class JwtService {
    ...
    public String generateAccessToken(UserDetails userDetails) {
        return generateToken(new HashMap<>(), userDetails, jwtConfig.getAccessTokenExpiry());
    }

    public String generateRefreshToken(UserDetails userDetails) {
        return generateToken(new HashMap<>(), userDetails, jwtConfig.getRefreshTokenExpiry());
    }
