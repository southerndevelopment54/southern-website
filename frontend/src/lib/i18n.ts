...
export const translations = {
  zh: {
    ...
    about: {
      ...
      pageTitle: "公司背景",
      companyName: "南方(警衛及管業)有限公司",
      intro: "於一九九七年成立迄今己逾二十載，所有管理階層均為資深保安從業員，向以提供專業保安服務為宗旨。",
      description: "本公司現僱用約500名保安人員為我們尊貴的客戶在不同的商業大廈、屋苑、學校、廠房、商場、物流倉庫及建築地盤提供專業警衛服務。此外，本公司亦提供短期保安人員在展覽及盛事場地執行任務。\n\n本公司所聘用之保安人員均已接受政府認可機構之培訓及持有有效之培訓證書及保安人員許可證。除基本培訓外，本公司會為有關保安人員提供在職培訓以迎合客戶之特別需求，從而提升服務水平以確保客戶財產之安全。\n\n南方設有24小時中央監控中心，由高級主管監察所有崗位運作，以電話聯絡或突擊查詢有關崗位事宜。此外，南方之巡查主任會不定時到各崗位查察當值保安人員之狀況。\n\n南方一直以最專業的服務，最合理的價格成為我們尊貴客戶最信賴的長期合作夥伴。",
    ...
    services: {
      ...
      items: [
        { title: "商業大廈保安", description: "為寫字樓、商業中心提供門禁管理、巡邏監察及訪客登記等全面保安服務，確保商業環境安全有序。", detail: "我們為商業大廈、寫字樓及商業中心提供全面的保安服務，涵蓋門禁管理、訪客登記、巡邏監察及緊急應變等。我們的保安團隊均持有專業牌照，具備豐富的商業物業管理經驗，能夠有效預防及處理各類安全事件，確保商業環境安全有序，讓租戶及訪客安心工作及出入。\n\n我們會根據每座商業大廈的獨特需求，量身定制保安方案，並提供24小時控制中心支援。無論日間繁忙時段或夜間非辦公時間，我們的團隊時刻保持高度警覺，為您的物業提供無間斷的專業守護。" },
  ...
  cn: {
    ...
    about: {
      ...
      pageTitle: "公司背景",
      companyName: "南方(警卫及管业)有限公司",
      intro: "于一九九七年成立迄今己逾二十载，所有管理阶层均为资深保安从业员，向以提供专业保安服务为宗旨。",
      description: "本公司现雇用约500名保安人员为我们尊贵的客户在不同的商业大厦、屋苑、学校、厂房、商场、物流仓库及建筑地盘提供专业警卫服务。此外，本公司亦提供短期保安人员在展览及盛事场地执行任务。\n\n本公司所聘用之保安人员均已接受政府认可机构之培训及持有有效之培训证书及保安人员许可证。除基本培训外，本公司会为有关保安人员提供在职培训以迎合客户之特别需求，从而提升服务水平以确保客户财产之安全。\n\n南方设有24小时中央监控中心，由高级主管监察所有岗位运作，以电话联络或突击查询有关岗位事宜。此外，南方之巡查主任会不定时到各岗位查察当值保安人员之状况。\n\n南方一直以最专业的服务，最合理的价格成为我们尊贵客户最信赖的长期合作伙伴。",
    ...
    services: {
      ...
      items: [
        { title: "商业大廈保安", description: "为写字楼、商业中心提供门禁管理、巡逻监察及访客登记等全面保安服务，确保商业环境安全有序。", detail: "我们为商业大廈、写字楼及商业中心提供全面的保安服务，涵盖门禁管理、访客登记、巡逻监察及紧急应变等。我们的保安团队均持有专业牌照，具备丰富的商业物业管理经验，能够有效预防及处理各类安全事件，确保商业环境安全有序，让租户及访客安心工作及出入。\n\n我们会根据每座商业大廈的独特需求，量身定制保安方案，并提供24小时控制中心支援。无论日间繁忙时段或夜间非办公时间，我们的团队时刻保持高度警觉，为您的物业提供无间断的专业守护。" },
    ...
    contact: {
      ...
      company: "公司名稱",
      companyPlaceholder: "请输入公司名稱（如適用）",
      phoneLabel: "联系电话",
      phonePlaceholder: "请输入电话号码",
      emailLabel: "电邮地址",
      emailPlaceholder: "请输入电邮地址",
  ...
  en: {
    ...
    about: {
      ...
      intro: " was established in 1997 in Hong Kong with its Headquarters situated at New Treasure Centre, San Po Kong, Kowloon, Hong Kong. We specialize in the provision of first class professional Security Services including Security Guarding, Gurkha Guarding, Key Holding, Mobile Patrolling, Close Protection, Body Guard, Car pick up and transit and all related Security Consultancy Services on a comprehensive package basis.",
      description: "At present, we have a strong force of about 500 security personnel posted at various locations which include, High-Class Residential Buildings, Commercial Complex, Parking Areas, Logistics Warehouse and Construction Sites, etc. In additional, we also provide ad-hoc security services for Road-Shows, Exhibition, Big event conference and the like.\n\nAll security personnel employed are required to receive stringent trainings before being assigned to any post, thus ensuring that they all have the proper security manning / guarding knowledge and are well-aware of their responsibilities. Training subjects include crime prevention, fire prevention and protection, power of arrest, use of force under Security and Guarding Services Ordinances, basic knowledge of proper management and communication. In addition, on-job training is also arranged such as crowd and traffic control, security system and CCTV monitoring and patrolling procedures.\n\nOur Control Room is set up to the required standard with 24-hour manning daily by high rank officers. Supervisor of a particular post has to report all security matters of the site hourly to our Control Room. From there, our duty officers will take immediate appropriate actions and rectify any irregularities, if required.\n\nFor your information, all our key members are very well-experienced in the security field, some of them with military service background.",
    ...
    services: {
      ...
      items: [
        { title: "Commercial Building Security", description: "Comprehensive security services for offices and commercial centres, including access control, patrol monitoring, and visitor registration.", detail: "We provide comprehensive security services for commercial buildings, office towers, and business centres, covering access control, visitor registration, patrol monitoring, and emergency response. Our security team holds professional licenses and has extensive experience in commercial property management, effectively preventing and handling all types of security incidents to ensure a safe and orderly business environment, allowing tenants and visitors to work and move about with peace of mind.\n\nWe tailor security solutions to the unique needs of each commercial building and provide 24-hour control centre support. Whether during busy daytime hours or quiet nighttime periods, our team remains highly vigilant to provide uninterrupted professional protection for your property." },
