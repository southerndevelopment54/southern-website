  ...
  zh: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "保安系統服務", description: "提供先進的保安系統設計及安裝服務，包括閉路電視、門禁系統、警報系統等，為您的物業提供全天候的智能安全保護。", detail: "我們提供先進的保安系統設計、安裝及維護服務，包括閉路電視系統、門禁控制系統、警報系統、入侵偵測系統及24小時遠程監控等。我們的專業團隊會根據客戶的需求及物業特點，度身訂造最合適的保安系統方案，為您的物業提供全天候的智能安全保護。" },
  ...
  cn: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "保安系统服务", description: "提供先进的保安系统设计及安装服务，包括闭路电视、门禁系统、警报系统等，为您的物业提供全天候的智能安全保护。", detail: "我们提供先进的保安系统设计、安装及维护服务，包括闭路电视系统、门禁控制系统、警报系统、入侵侦测系统及24小时远程监控等。我们的专业团队会根据客户的需求及物业特点，度身订造最合适的保安系统方案，为您的物业提供全天候的智能安全保护。" },
  ...
  en: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "Security System Services", description: "Advanced security system design and installation services, including CCTV, access control, alarm systems, and more, offering round-the-clock intelligent protection for your property.", detail: "We provide advanced security system design, installation, and maintenance services, including CCTV systems, access control systems, alarm systems, intrusion detection systems, and 24-hour remote monitoring. Our professional team will tailor the most suitable security system solution based on client needs and property characteristics, providing round-the-clock intelligent security protection for your property." },
