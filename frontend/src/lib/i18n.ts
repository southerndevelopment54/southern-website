  ...
  zh: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "個人護衛服務", description: "為企業高管、名人及有特殊安全需要的個人提供專業貼身護衛，確保人身安全。", detail: "我們為企業高管、名人、貴賓及有特殊安全需要的個人提供專業的貼身護衛服務。我們的護衛人員均經過嚴格的專業訓練，具備敏銳的觀察力及應變能力，能夠在任何場合確保受護衛人員的人身安全，同時保持低調及專業。" },
        { title: "保安系統服務", description: "提供先進的保安系統設計及安裝服務，包括閉路電視、門禁系統、警報系統等，為您的物業提供全天候的智能安全保護。", detail: "我們的附屬公司國民警鐘有限公司（CNT Alarm System Company Limited）成立於1992年，總部設於香港新蒲崗五芳街10號新寶中心。國民警鐘致力為客戶評估需求、提供專業建議、設計解決方案、安裝系統，並持續維護整合系統，以配合客戶的要求及預算。\n\n國民警鐘擁有逾20年業界經驗，為香港保安專業學會會員，並於1995年成為香港警務處警察總部防止罪案科認可承辦商，處理由該科轉介的服務。\n\n我們提供的保安系統服務包括：生物識別門禁系統、巡更系統、防盜警報系統、樓宇自動化系統、停車場自動化系統、公共廣播及音響系統、中央警報監控服務、無線射頻識別系統、閉路電視監控系統、中央GPS/GSM監控服務、數碼錄影/網絡系統/IP攝像機方案，以及車輛追蹤系統。" },
  ...
  cn: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "保安系统服务", description: "提供先进的保安系统设计及安装服务，包括闭路电视、门禁系统、警报系统等，为您的物业提供全天候的智能安全保护。", detail: "我们的附属公司国民警钟有限公司（CNT Alarm System Company Limited）成立于1992年，总部设于香港新蒲岗五芳街10号新宝中心。国民警钟致力为客户评估需求、提供专业建议、设计解决方案、安装系统，并持续维护整合系统，以配合客户的要求及预算。\n\n国民警钟拥有逾20年业界经验，为香港保安专业学会会员，并于1995年成为香港警务处警察总部防止罪案科认可承办商，处理由该科转介的服务。\n\n我们提供的保安系统服务包括：生物识别门禁系统、巡更系统、防盗警报系统、楼宇自动化系统、停车场自动化系统、公共广播及音响系统、中央警报监控服务、无线射频识别系统、闭路电视监控系统、中央GPS/GSM监控服务、数码录像/网络系统/IP摄像机方案，以及车辆追踪系统。" },
  ...
  en: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "Security System Services", description: "Advanced security system design and installation services, including CCTV, access control, alarm systems, and more, offering round-the-clock intelligent protection for your property.", detail: "Our subsidiary, CNT Alarm System Company Limited (國民警鐘有限公司), was established in 1992 with its headquarters located at New Treasure Centre, 10 Ng Fong Street, San Po Kong, Kowloon, Hong Kong. CNT Alarm is committed to assessing customer needs, providing professional advice, designing solutions, installing systems, and continuously maintaining integrated systems to meet client requirements and budgets.\n\nWith over 20 years of industry experience, CNT Alarm is a member of the Hong Kong Security Association. In 1995, CNT Alarm became an approved contractor of the Crime Prevention Bureau, Hong Kong Police Force, handling services referred by the Bureau.\n\nOur security system services include: Biometric Access Control System, Guard Tour System, Burglar Alarm System, Building Automation System, Carpark Automation System, Public Address and Sound System, Central Alarm Monitoring Service, Radio Frequency Identification System, Closed Circuit Television Surveillance System, Central GPS / GSM Monitoring Service, Digital Video Recording / Networking System / IP Camera Solutions System, and Vehicle Tracking System." },
