...
export const translations = {
  zh: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "保安系統服務", description: "提供先進的保安系統設計及安裝服務，包括閉路電視、門禁系統、警報系統等，為您的物業提供全天候的智能安全保護。", detail: "我們的附屬公司國民警鐘有限公司（CNT Alarm System Company Limited）成立於1992年，總部設於香港新蒲崗五芳街10號新寶中心21樓5-7室，擁有逾30年業界經驗。國民警鐘致力為客戶評估需求、提供專業建議、設計解決方案、安裝系統，並持續維護整合系統，以配合客戶的要求及預算。\n\n我們提供的保安系統服務包括：\n• 門禁管理系統\n• 閉路電視監控系統\n• 防盜警報系統\n• 中央監控系統\n• 停車場管理系統\n• 樓宇自動化系統\n• 公共廣播系統\n• 巡更系統\n• 無線射頻識別系統\n• 中央GPS/GSM監控服務\n• 數碼錄影/網絡系統/IP攝像機方案\n• 車輛追蹤系統" },
    ...
    clientShowcase: {
      ...
      tabCommercial: "商廈/商場",
      tabResidential: "住宅",
      tabGovernmentInfrastructure: "政府基建",
      tabHotel: "酒店",
    ...
    vacancies: {
      ...
      contactUsInquiry: {
        ...
        licenseNumber: "保安牌照號碼",
        licenseNumberPlaceholder: "請輸入保安牌照號碼",
        serviceType: "服務類型",
      ...
      applyForm: {
        ...
        licenseNumber: "保安牌照號碼",
        licenseNumberPlaceholder: "請輸入保安牌照號碼",
        licenseNumberRequired: "請輸入保安牌照號碼。",
        message: "其他訊息",
    ...
    contact: {
      ...
      inquiryTitle: "客戶服務查詢",
      inquirySubtitle: "歡迎客戶查詢我們的保安服務。如欲申請職位，請前往「職位空缺」頁面。",
      name: "聯絡人姓名",
  ...
  cn: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "保安系统服务", description: "提供先进的保安系统设计及安装服务，包括闭路电视、门禁系统、警报系统等，为您的物业提供全天候的智能安全保护。", detail: "我们的附属公司国民警钟有限公司（CNT Alarm System Company Limited）成立于1992年，总部设于香港新蒲岗五芳街10号新宝中心21楼5-7室，拥有逾30年业界经验。国民警钟致力为客户评估需求、提供专业建议、设计解决方案、安装系统，并持续维护整合系统，以配合客户的要求及预算。\n\n我们提供的保安系统服务包括：\n• 门禁管理系统\n• 闭路电视监控系统\n• 防盗警报系统\n• 中央监控系统\n• 停车场管理系统\n• 楼宇自动化系统\n• 公共广播系统\n• 巡更系统\n• 无线射频识别系统\n• 中央GPS/GSM监控服务\n• 数码录像/网络系统/IP摄像机方案\n• 车辆追踪系统" },
    ...
    vacancies: {
      ...
      contactUsInquiry: {
        ...
        licenseNumber: "保安牌照号码",
        licenseNumberPlaceholder: "请输入保安牌照号码",
        serviceType: "服务类型",
      ...
      applyForm: {
        ...
        licenseNumber: "保安牌照号码",
        licenseNumberPlaceholder: "请输入保安牌照号码",
        licenseNumberRequired: "请输入保安牌照号码。",
        message: "其他讯息",
    ...
    contact: {
      ...
      officeHours: "星期一至五：09:00 - 18:00",
      inquiryTitle: "客户服务查询",
      inquirySubtitle: "欢迎客户查询我们的保安服务。如欲申请职位，请前往「职位空缺」页面。",
      name: "联系人姓名",
  ...
  en: {
    ...
    clientShowcase: {
      ...
      tabGovernmentInfrastructure: "Government Infrastructure",
      tabHotel: "Hotel",
    ...
    vacancies: {
      ...
      contactUs: "Contact Us for More Positions",
      contactUsInquiry: {
        title: "Contact Us for More Positions",
        ...
        licenseNumber: "Security Licence Number",
        licenseNumberPlaceholder: "Enter security licence number",
      ...
      applyForm: {
        ...
        licenseNumber: "Security Licence Number",
        licenseNumberPlaceholder: "Enter security licence number",
        licenseNumberRequired: "Please enter your security licence number.",
    ...
    contact: {
      ...
      inquiryTitle: "Client Service Inquiry",
      inquirySubtitle: "For clients interested in our security services. To apply for a position, please visit Careers.",
      name: "Contact Name",
    ...
    footer: {
      ...
      licenseNo: "Security Licence No.: 0646",
